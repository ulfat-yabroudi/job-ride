<template>
    <v-container id="reviews">
      <v-row>
      <v-col cols="12">
        <div class=" text-h2 text-center mt-7 teal--text ">
          Reviews
        </div>
      </v-col>
      <v-col
  ...
  <v-card-actions>
      <v-list-item class="grow">
        ...
        <v-list-item-content>
          <v-list-item-title class="black--text text-h6">{{review.username}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
    </v-card-actions>
    <v-rating
    ...
    reviews: [
      {
        ...
        username: 'Reem sh',
        comment: '  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est, hic.',
        rate: '4.5'
      },
      {
      ...
      {
        src: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzB8fHBlb3BsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
        username: 'Nour ahmad',
        comment: '  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Est, hic.',
        rate: '3'
      }
